...
public class KdGoldAPIDemo{
	...
	//电商ID
	private static String EBusinessID="1632144";
	//电商加密私钥，快递鸟提供，注意保管，不要泄漏
	private static String AppKey="3d2bc24e-efb7-4612-b811-ed2d82c16d4c";
	...
	public static void main(String[] args) throws Exception{
		String result = orderOnlineByJson();
		System.out.println("---------result-----------"+result);
		Object parse = JSON.parse(result);
		JSONObject jsonObject = JSON.parseObject(result);
		String printTemplate = jsonObject.get("PrintTemplate").toString();
		System.out.println("---------");
